 ...
 * @author prince
 */
public class add_stu_det extends javax.swing.JFrame {

    /**
     * Creates new form add_stu_det
     */
    public add_stu_det() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query_login = "insert into login values ('"+id+"','"+password+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_stu_det.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
